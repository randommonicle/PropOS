...
import { BankAccountsTab, ServiceChargeAccountsTab } from '@/components/modules/financial'
...
const TAB_VALUES = ['overview', 'units', 'leaseholders', 'bank-accounts', 'service-charge-accounts'] as const
    ...
    <div>
      ...
      <div className="p-8">
        <Tabs value={tab} onValueChange={handleTabChange}>
          ...
          {/* ── Service charge accounts tab ──────────────────────────────── */}
          <TabsContent value="service-charge-accounts" className="space-y-8">
            <ServiceChargeAccountsTab firmId={firmContext!.firmId} propertyId={property.id} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
